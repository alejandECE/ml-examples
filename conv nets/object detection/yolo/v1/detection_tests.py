...
if __name__ == '__main__':
  ...
  checkpoint_path = utils.OUTPUTS / args.checkpoint
  ...
  viewer.visualize_detection_examples(model, train_unprocessed_ds, index_to_category, examples=10)
  # viewer.visualize_detection_examples(model, test_unprocessed_ds, index_to_category, examples=5)
