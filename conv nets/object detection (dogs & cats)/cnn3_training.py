...
if __name__ == '__main__':
  ...
  mdl = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(units=128, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(0.00)),
  ...
  results = mdl.fit(training_ds, validation_data=testing_ds, epochs=20, callbacks=[], verbose=2)
  # Shows performance to console
  show_performance(results)
  # Saves model
  # mdl.save('trained_model/cnn3/')
